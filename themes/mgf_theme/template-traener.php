...
$traener_query = new WP_Query(array(
    'post_type' => 'traener', // Bruger den brugerdefinerede posttype
    'posts_per_page' => -1, // Vis alle medarbejdere, fjern denne linje for at begrænse antallet
));

// Loop gennem medarbejdere og vis dem
if ($traener_query->have_posts()) :
    while ($traener_query->have_posts()) : $traener_query->the_post();
?>
